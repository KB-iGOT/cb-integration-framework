...
public class IntegrationConstant {
    ...
    public static final String FLUX_FILE_KEY="files";

    public static final String CONTENT_TYPE_HEADER_KEY = "content-type";
    public static final String DEFAULT_CONTENT_TYPE_HEADER_VALUE = "application/json";
}
